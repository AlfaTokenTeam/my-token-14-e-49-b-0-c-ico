...
import "./MyToken14E49B0C.sol";

contract MyToken14E49B0CPreSale {
    MyToken14E49B0C public token;
    ...
    function MyToken14E49B0CPreSale(
        MyToken14E49B0C _token,
        address _beneficiary,
        address _alfatokenteam
    ) {
        token = MyToken14E49B0C(_token);
